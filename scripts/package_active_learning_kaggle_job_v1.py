...
from finance_query.active_learning_models import MODEL_JOB_PROTOCOL  # noqa: E402
from finance_query.evidence_closure import load_json, sha256_file  # noqa: E402
...
def main() -> None:
    ...
    if source.get("protocol") != MODEL_JOB_PROTOCOL or source.get("status") != "PREPARED_GPU_EXECUTION_NOT_RUN":
        raise ValueError("invalid prepared model job")

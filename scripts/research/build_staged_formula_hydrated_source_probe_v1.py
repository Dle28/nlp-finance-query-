#!/usr/bin/env python3
"""Build an in-memory sidecar hydration diagnostic for staged formulas."""
...
from finance_query.research.staged_formula_hydrated_source_probe import build_staged_formula_hydrated_source_probe
...
def main() -> None:
    ...
    print(json.dumps(build_staged_formula_hydrated_source_probe(

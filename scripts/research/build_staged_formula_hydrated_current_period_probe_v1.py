#!/usr/bin/env python3
"""Build a hydrated current-period source diagnostic for staged formulas."""
...
from finance_query.research.staged_formula_hydrated_current_period_probe import build_staged_formula_hydrated_current_period_probe


def main() -> None:
    parser = argparse.ArgumentParser()
    for name in (
        "plans", "targets", "candidate-artifact-dir", "full-assets", "full-assets-manifest",
        "structured-tables", "evidence-context", "evidence-context-manifest", "output-dir",
    ):
    ...
    print(json.dumps(build_staged_formula_hydrated_current_period_probe(

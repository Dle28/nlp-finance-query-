#!/usr/bin/env python3
"""Build a source-title current-period recheck for staged formula operands."""
...
from finance_query.research.staged_formula_current_period_probe import build_staged_formula_current_period_probe


def main() -> None:
    parser = argparse.ArgumentParser()
    for name in ("plans", "targets", "candidate-artifact-dir", "structured-tables", "evidence-context", "evidence-context-manifest", "output-dir"):
    ...
    print(json.dumps(build_staged_formula_current_period_probe(

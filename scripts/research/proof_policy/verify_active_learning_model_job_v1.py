...
from finance_query.research.proof_policy.active_learning_models import MODEL_JOB_PROTOCOL, build_model_job  # noqa: E402
from finance_query.research.proof_policy.evidence_closure import load_json, load_jsonl, sha256_file  # noqa: E402
...
def verify(path: Path) -> dict[str, object]:
    ...
    for name in ("packets", "proposer_requests"):

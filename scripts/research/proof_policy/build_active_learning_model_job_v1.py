#!/usr/bin/env python3
"""Build blind Qwen proposer requests for active-learning research."""
...
from finance_query.research.proof_policy.active_learning_models import build_model_job  # noqa: E402

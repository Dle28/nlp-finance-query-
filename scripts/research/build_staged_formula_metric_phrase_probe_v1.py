#!/usr/bin/env python3
"""Build a controlled phrase-based source diagnostic for staged formulas."""
...
from finance_query.research.staged_formula_metric_phrase_probe import build_staged_formula_metric_phrase_probe


def main() -> None:
    parser = argparse.ArgumentParser()
    for name in (
        "config", "plans", "candidate-artifact-dir", "baseline-literal-artifact-dir",
        "baseline-current-artifact-dir", "full-assets", "full-assets-manifest", "structured-tables",
    ...
    print(json.dumps(build_staged_formula_metric_phrase_probe(
        config_path=args.config,
        plans_path=args.plans,
        candidate_artifact_dir=args.candidate_artifact_dir,
        baseline_literal_artifact_dir=args.baseline_literal_artifact_dir,
        baseline_current_artifact_dir=args.baseline_current_artifact_dir,

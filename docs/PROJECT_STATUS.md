...
| V13 claim-requirement shadow audit | Complete; non-promotable | All 1,012 claims have a versioned requirement set and Semantic Coverage Certificate V2. The first-blocker partition is 595 composed, 353 route, 38 temporal and 26 V12 certificate candidates. Sixteen of those 26 are internally complete under V13; ten expose unresolved `accounting.basis`. All 1,012 remain `CLAIM_COMPLETENESS_UNESTABLISHED`; V12 lineage and the blocked release decision are unchanged. |

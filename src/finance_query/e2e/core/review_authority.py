...
def validate_gate_reviewer(
    ...
    *,
    ...
    """Validate a native-human or explicit ChatGPT human-equivalent review."""
    ...
    if reviewer_type == HUMAN_REVIEWER_TYPE:
        ...
        return {"reviewer_type": reviewer_type, "reviewer_id": reviewer_id, "verification_authority": HUMAN_REVIEWER_TYPE, "gate_effect": "native_human_verified", "grant_scope": grant_scope}
    ...
    if (
        ...
        or not _text(record.get("model_family"))
    ...
    return {"reviewer_type": reviewer_type, "reviewer_id": reviewer_id, "verification_authority": HUMAN_EQUIVALENT, "gate_effect": GATE_EFFECT, "grant_scope": grant_scope}

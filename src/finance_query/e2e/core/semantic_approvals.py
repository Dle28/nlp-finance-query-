...
from finance_query.e2e.core.review_authority import (
    ...
    for decision in _rows(decisions):
        ...
        if entity_role:
            ...
            if role_line_anchor:
                ...
                if entity_role == "parent" and not direct_parent_literal:
                    raise SemanticApprovalError("source line does not explicitly prove parent role")

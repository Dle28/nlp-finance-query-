...
from .execution import OPERATOR_REGISTRY
from .answer_certificates import temporal_contract_for_operand
from .financial_metrics import infer_formula_spec
from .questions import metric_hint, normalize_text, reported_value_lookup_reason
from .report_entities import resolve_question_entity
    ...
    *,
    ...
    if op in {"max", "min"} and YEAR_RESULT_RE.search(normalized):
        ...
        return (
            ...
            ["SINGLE_METRIC_PERIOD_SELECTOR", "EXECUTOR_COMPILATION_REQUIRED"],
        )
    return (
        operands,
        {"op": op, "args": [operand["operand_id"] for operand in operands]},
